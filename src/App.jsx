    ...
    <div className="animate-fade-in w-full">
      ...
      <footer className="mt-20 pb-10 text-slate-400 text-sm font-medium">
        ...
        <div className="flex items-center justify-center gap-6 mt-4">
          ...
          <span className="flex items-center gap-1.5"><Youtube className="w-4 h-4 text-rose-500" /> YouTube Live</span>
          <span className="flex items-center gap-1.5"><Facebook className="w-4 h-4 text-blue-600" /> Facebook Live</span>
        </div>
      </footer>
    </div>
  )
